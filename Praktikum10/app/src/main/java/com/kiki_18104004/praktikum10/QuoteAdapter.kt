...
import com.kiki_18104004.praktikum10.databinding.ItemQuoteBinding
...
class QuoteAdapter(private val activity: Activity) :
    ...
    inner class QuoteViewHolder(itemView: View) :
        ...
        fun bind(quote: Quote, position: Int) {
            ...
            binding.tvItemUmur.text = quote.Umur.toString()
            binding.tvItemHobby.text = quote.Hobby.toString()

...
import com.kiki_18104004.praktikum10.db.DatabaseContract.QuoteColumns.Companion.TABLE_QUOTE
...
internal class DatabaseHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val SQL_CREATE_TABLE_QUOTE = "CREATE TABLE $TABLE_QUOTE" +
                " (${DatabaseContract.QuoteColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT," + " ${DatabaseContract.QuoteColumns.TITLE} TEXT NOT NULL," +
                " ${DatabaseContract.QuoteColumns.DESCRIPTION} TEXT NOT NULL," +
                " ${DatabaseContract.QuoteColumns.CATEGORY} TEXT NOT NULL," +
                " ${DatabaseContract.QuoteColumns.UMUR} INTEGER NOT NULL,"+
                " ${DatabaseContract.QuoteColumns.HOBBY} TEXT NOT NULL," +
